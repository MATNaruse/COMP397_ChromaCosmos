var Collision;
(function (Collision) {
    function Detect(Incoming, Target) {
        ...
        */
        ...
        if (Incoming.x < (Target.x + (Target.halfW * Target.ImgScale)) && Incoming.x > (Target.x - (Target.halfW * Target.ImgScale))) { //If its within the object's range on X axis
    ...
    Collision.Detect = Detect;
})(Collision || (Collision = {}));
//# sourceMappingURL=collision_manager.js.map